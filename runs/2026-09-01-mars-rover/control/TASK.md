...
Done when everything above is implemented and verified. Interface, module
layout, and report formats are yours to decide. The task statement is
deliberately silent on them.
